...
public class Reemplazar extends javax.swing.JDialog {
  ...
  Principal ver=new Principal();
    ...
    private void boton_buscar_siguienteActionPerformed(java.awt.event.ActionEvent evt) {                                                       
  
        Find(0);
       
    }                                                      

    private void texto_buscarActionPerformed(java.awt.event.ActionEvent evt) {                                             
    ...
    private void texto_buscarKeyPressed(java.awt.event.KeyEvent evt) {                                        
    ...
    private void boton_reemplazarActionPerformed(java.awt.event.ActionEvent evt) {                                                 
    ...
    private void coincidir_todoItemStateChanged(java.awt.event.ItemEvent evt) {                                                
    ...
    private void boton_reemplazar_todoActionPerformed(java.awt.event.ActionEvent evt) {                                                      
